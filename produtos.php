<?php
require_once('./modelo/produtosDAO.php');
                    ...
                    <div class="modal-body">
                        <form action="./controle/ctr_produtos.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Digite seu nome" id="iNome" name="txtNome">
                            </div>
                            <div class="form-group">
                                <label for="iQtd">Quantidade:</label>
                                <input type="text" class="form-control" placeholder="Digite sua idade" id="iQtd" name="txtQuantidade">
                            </div>
                            <div class="form-group">
                                <label for="iValor">Valor:</label>
                                <input type="text" class="form-control" placeholder="Digite seu CPF" id="iValor" name="txtValor">
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="./controle/ctr_produtos.php" method="post">
                            ...
                            <div class="form-group">
                                <label for="iQtd">Quantidade:</label>
                                <input type="text" class="form-control" placeholder="Digite sua idade" id="recipient-quantidade" name="txtQuantidade">
                            </div>
                            <div class="form-group">
                                <label for="iValor">Valor:</label>
                                <input type="text" class="form-control" placeholder="Digite seu CPF" id="recipient-valor" name="txtValor">
                            </div>
                            <div class="formAlign">
