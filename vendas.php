<?php
require_once('./modelo/vendasDAO.php');
        ...
        <table class="table table-striped text-center">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Dia Venda</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button 
                                    ...
                                    data-id="<?php 
                                     #<!-- Manipular o nome do 'data-' e no objVendas['tambem'] -->
                                     echo $objVendas['id']; ?>"
                                    data-nome="<?php echo $objVendas['nome']; ?>"
                                    data-idade="<?php echo $objVendas['idade']; ?>"
                                    data-cpf="<?php echo $objVendas['cpf']; ?>"
                                    > Editar 
                                </button> 
                            </td>
                            <td>
                                <button 
                                    ...
                                    data-nome="<?php echo $objVendas['nome']; ?>"> Deletar 
                                </button> 
                            </td>
                        </tr>
                <?php
